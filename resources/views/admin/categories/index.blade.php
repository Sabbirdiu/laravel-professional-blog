        ...
        <div class="content mt-3">
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{route('category.store')}}" method="post" id="createCategory" enctype="multipart/form-data" class="form-horizontal">
                                    @csrf
            ...
            <div class="modal fade" id="editModal-{{$category->id}}" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel"
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{route('category.update', $category->id)}}" method="post" id="editcategory-{{$category->id}}" enctype="multipart/form-data" class="form-horizontal">
                                @csrf
                                @method('PUT')
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Name</label></div>
            ...
            <div class="modal fade" id="deleteModal-{{$category->id}}" tabindex="-1" role="dialog" aria-labelledby="staticModalLabel"
                ...
                <div class="modal-dialog modal-sm" role="document">
                    ...
                    <form action="{{route('category.destroy', $category->id)}}" style="display: none" id="deletecategory-{{$category->id}}" method="POST">
                        @csrf
                        @method('DELETE')
                    </form>
                        </div>
